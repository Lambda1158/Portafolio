...
import fisiocalendar from '../../public/fullness.photos/fisio-calendar.png';
import fisiohome2 from '../../public/fullness.photos/fisio-home-2.png';
import fisiohome from '../../public/fullness.photos/fisio-home.png';
import fisioprofile2 from '../../public/fullness.photos/fisio-profile-2.png';
import fisioprofile from '../../public/fullness.photos/fisio-profile.png';
...
const projectData = [
  {
    ...
    description:
      'Gusto es una app de recetas que consume una API externa para mostrar, filtrar y buscar recetas. Además, permite crear nuevas recetas y guardarlas en una base de datos para su gestión personalizada.',
    title: 'Gusto Gourmet',
    github: 'https://github.com/Lambda1158/Recipes-App',
    live: 'https://recipes-app-ten-alpha.vercel.app/',
    url: 'Gusto-Gourmet',
    tech: [
      { tech: HTML5icon, text: 'HTML5' },
      { tech: CSSicon, text: 'CSS' },
      { tech: React, text: 'React.js' },
      { tech: Redux, text: 'Redux' },
      { tech: Expressjs, text: 'Express.js' },
      { tech: Nodejs, text: 'Node.js' },
      { tech: PostgreSQL, text: 'PostgreSQL' },
    ],
  },
  {
    image: [
    ...
    tech: [
      ...
      { tech: Nodejs, text: 'Node.js' },
      { tech: PostgreSQL, text: 'PostgreSQL' },
      { tech: TailwindCSS, text: 'TailwindCSS' },
    ],
  },
  {
    image: [landing1, menu, about, about1, card, contact, mail, project],
    description:
      'Mi portafolio personal en Next.js 13, que integra Framer Motion, React-Hot-Toast y Nodemailer para animaciones, notificaciones y contacto por correo. Me inspiré en un diseño popular de Figma, combinándolo con ideas de la comunidad.',
    title: 'Portafolio',
    ...
    tech: [
      ...
      { tech: Expressjs, text: 'Express.js' },
      { tech: Nodejs, text: 'Node.js' },
      { tech: Nextjs, text: 'Next.js' },
      { tech: TailwindCSS, text: 'TailwindCSS' },
    ],
  },
  {
    image: [fisiohome, fisiocalendar, fisiohome2, fisioprofile, fisioprofile2],
    description:
      'Fullnes es un sistema diseñado para gestionar turnos entre profesionales de la fisioterapia y sus pacientes en el que participe solucionando problemas, puliendo detalles y agregando features.',
    title: 'Fisionfulness - Fullness',
    github: '',
    live: '',
    url: 'Fullness',
    tech: [
      ...
      { tech: Expressjs, text: 'Express.js' },
      { tech: Nodejs, text: 'Node.js' },
      { tech: MongoDB, text: 'MongoDB' },
      { tech: TailwindCSS, text: 'Tailwind' },
      { tech: Postman, text: 'Postman' },
    ],
  },
];
