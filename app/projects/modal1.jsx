...
function Modal1({ isOpen, onClose, img }) {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 z-50 bg-crema bg-opacity-[90%] dark:bg-opacity-[80%] h-full w-full ">
        le
      </div>
      <div className="fixed z-50 top-1/2 left-[50%] p-3  max-w-[1333px] max-h-full w-full transform  translate-y-[-50%] translate-x-[-50%] ">
        ...
        >
          <div className="relative px-[20px] lg:px-[35px] pt-[70px] lg:pt-[52px] pb-[35px]  rounded-[2px] bg-background">
            <button
